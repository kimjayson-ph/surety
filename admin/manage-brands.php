...
?>
	...
	<head>
		...
		<title>Motorbike Rental Portal |Admin Manage Brands </title>
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><a href="edit-brand.php?id=<?php echo $result->id; ?>"><i style="color: #7bc41d;" class="fa fa-edit"></i></a>&nbsp;&nbsp;
															<a href="manage-brands.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to delete');"><i style="color: #7bc41d;" class="fa fa-trash"></i></a>
														</td>
													</tr>
											<?php $cnt = $cnt + 1;
												}

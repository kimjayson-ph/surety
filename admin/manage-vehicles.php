...
?>
	...
	<head>
		...
		<title>Motorbike Rental Portal |Admin Manage Vehicles </title>
								...
								<div class="panel-body">
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.transmission,tblvehicles.ModelYear,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
											$query = $dbh->prepare($sql);
											$query->execute();
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><a href="edit-vehicle.php?id=<?php echo $result->id; ?>"><i style="color: #7bc41d;" class="fa fa-edit"></i></a>&nbsp;&nbsp;
															<a href="manage-vehicles.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to delete');"><i style="color: #7bc41d;" class="fa fa-trash"></i></a>
														</td>
													</tr>
											<?php $cnt = $cnt + 1;
												}

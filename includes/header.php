        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            ...
            <div class="header_widgets">
              <div class="circle_icon"><img src="assets/images/surety/header-email.png" style="height: 40px;" alt=""> </div>
              <p class="uppercase_text" style="color: #7bc41d;">Email </p>
              <a style="color: #7bc41d;" href="mailto:<?php echo htmlentities($email);  ?>"><?php echo htmlentities($email); ?></a>
            </div>
            <div class="header_widgets">
              <div class="circle_icon"> <img src="assets/images/surety/header-call.png" style="height: 40px;" alt=""> </div>
              <p class="uppercase_text" style="color: #7bc41d;">Please Make a Call </p>
              <a style="color: #7bc41d;" href="tel:<?php echo htmlentities($contactno); ?>"><?php echo htmlentities($contactno); ?></a>
            </div>
            <div class="social-follow">
              <div class="user_login" style="background-color: #7bc41d;">
                <ul>
